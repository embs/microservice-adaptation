...
public class OneByOneProcessingUnit extends AbstractProcessingUnit {
	...
	public ChangeRequestEvent evaluate() throws InterruptedException {
		...
		ChangeRequestEvent event = checkingResult ? ChangeRequestEvent.getNullChangeRequestEvent() : new ChangeRequestEvent(property.getName(), symptom.getSource(), Collections.emptyMap());
